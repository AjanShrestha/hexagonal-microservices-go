...
// NewRedisRepository returns the RedisRepository interface object
...
// generateKey is a util func that returns a new key to get data from db
func (r *redisRepository) generateKey(code string) string {
	return fmt.Sprintf("redirect:%s", code)
}

// Find searches the db with the code and returns a redirect
...
// Store takes in the URL and stores it in redis db
